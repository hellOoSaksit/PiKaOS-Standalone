...
| **URL Redirect Map** | Map every **old-site URL → new target**, verify both sides, generate an IIS `web.config` + an Excel checklist | `5175 / 8002` | **0.2.1** · [release](https://github.com/hellOoSaksit/PiKaOS-Standalone/releases/tag/redirect-map-v0.2.1) | [`PikaOS-RedirectMap/`](PikaOS-RedirectMap) | [README](PikaOS-RedirectMap/README.md) |
